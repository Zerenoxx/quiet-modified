...
.ui-standard-sidebar-view #bd-settingspane-container .content-column.default .bda-slist::before{content: "Quiet v" var(--version-content) "\A \A Theme Options:\A \A - Show/Hide Blocked messages\A - Loading Theme Animation\A - Remove spacing between messages \A - Remove Channel Mentions Bar \A - Remove Server Mentions Bar\A - Remove Embed Enlarging\A - Christmas Things\A - Normal Guild/Server Icon Sizes\A - Circle Avatars\A - Revert bottom to default look\A - Minimized Channel Members\A - Background Around Messages\A - Minimized Servers\A - Nitro Tag \A \A Go to discord.io/mrrobot to show love and support! <3"!important;}

.need-help-modal .header h1::after{content:"Quiet v" var(--version-content);color:#fff;font-weight:700;font-size:250%;z-index:11;position:absolute;width:200%;left: 0px;margin-left: -45px;top: 16px;font-family:Satisfy;text-shadow:1px 1px 1px rgba(0, 0, 0, 0.4);}

#bd-settingspane-container .content-column.default .ui-form-title.h2::after{content: "Hi, I have a server where I post customizable options for the theme and you can give \A me feedback, also with tons of bots. Join the server at discord.io/mrrobot \A\A It's also easier to report bugs and has a higher change of getting them fixed faster."!important;}
...
body:before{content:"Thanks for using Quiet!";z-index:1000000000000000000000000;color:#fff;background:var(--main-color);top:0px;left:50%;position:absolute;border-radius:5px;padding:5px 15px;-webkit-transform:translate(-50%, -100%);transform:translate(-50%, -100%);-webkit-animation:version 3s ease;animation:version 3s ease;-webkit-animation-delay:4s;animation-delay:4s;}
...
.typing{font-size:11px; z-index: 3;margin-left: 18px;}
...
background-repeat:no-repeat;padding-top:8px;padding-bottom:8px;text-align:center;border-radius:3px;width:145px;margin-left:15px;}
...
.private-channels .search-bar input{background:#19191b !important;}
...
.theme-dark .chat form{border-top: 2px solid #212121 !important;border-left: 2px solid #212121 !important;border-right: 2px solid #212121 !important;}
...
#friends .friends-table .friends-row .friends-column-status .status{width:100%;height:20px;border-radius:5px 5px 0 0;position:absolute;top:0;opacity:0.5;z-index:0;}
...
.guilds{padding:20px 20px 85px 15px;}
...
.tab-bar.TOP .tab-bar-item:hover{border-bottom:2px solid var(--main-color);}
...
.guilds-wrapper .guilds-add{border: 0px solid transparent;position: fixed !important;bottom: 73px;width: 74px !important;border-radius: 0px;left: 0px;height: 3px !important;line-height: 1px;font-size: 0px !important;transition: .1s all linear;}
...
.private-channels .channel.selected .icon-friends{background-color:var(--hover-color);}
...
.guilds-wrapper .guilds{padding: 48px 0px 18px 14px;}
...
.scroller.guilds{height: calc(100% - 140px);}
...
.message-group:not(.compact) .avatar-large[style*="172218388880293888"] ~ .comment .message h2 span.username-wrapper::after,.channel-members .member .avatar-small[style*="172218388880293888"] ~ .member-inner .member-username .member-username-inner::after{content:"Developer";color:#fff;background:#7289da;border-radius:3px;margin-left:6px;font-size:10px;font-weight:600;padding:1px 4px;text-transform:uppercase;vertical-align:bottom;line-height:16px;-webkit-flex-shrink:0;flex-shrink:0;text-shadow: 0px 1px 3px #000;}
...
.channel-members .avatar-small .status-invisible,.private-channels .avatar-small .status-invisible,.account .avatar-small .status-invisible{border:2px solid ##00FF73 !important;}
...
.status.status-typing.status-invisible{width:26px!important;right:-11px!important;height:8px !important;background:##00FF73 !important;border:2px solid #19191b !important;margin:22px 0px 0px 14px;transition:.3s all linear;}
...
.user-popout .avatar-wrapper .avatar-popout .status.status-invisible{width:100%;height:100%;-webkit-border-radius:20px;border-radius:75px;position:absolute;border:4px solid ##00FF73;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;bottom:0px;right:0px;z-index:2;-webkit-box-shadow:inset 0 0 0 0 rgba(255, 255, 255, .3);box-shadow:inset 0 0 0 0 rgba(255, 255, 255, .3);background:transparent;}
...
.status-picker .popout-menu-item:nth-child(5){background:##00FF73 !important;color:#fff;transition:.2s all linear;height:38px;}
...
.chat form{background:#19191b; border: none!important; margin: 0;box-shadow: 0 0 0 rgba(0,0,0,0);}

.emoji-picker .categories .item.selected{border-bottom-color:var(--main-color);}

.typing{height:18px;}

.typing .ellipsis{margin-top:5px;}
...
.theme-dark .message-group .embed{background-color:#111113;border-color:#111113;}
...
.message-group:not(.compact) .avatar-large[style*="81388395867156480"] ~ .comment .message h2 span.username-wrapper::after,.channel-members .member .avatar-small[style*="81388395867156480"] ~ .member-inner .member-username .member-username-inner::after{content:"Salty Developer";color:#fff;background:var(--main-color);border-radius:3px;margin-left:6px;font-size:10px;font-weight:600;padding:1px 2px;text-transform:uppercase;vertical-align:bottom;line-height:16px;-webkit-flex-shrink:0;flex-shrink:0;}
...
.theme-dark .message-group .comment .markup .mention{color:var(--main-color);background:#131315;border-radius:3px;padding:1px 4px 2px 3px;transition:.2s all linear;}
...
@media screen and (max-width:920px){.chat .content .flex-spacer.flex-vertical:not(:only-child) .message-group:not(.compact) h2 .timestamp{display:none;}

}

@media screen and (max-width:970px){.guilds-wrapper{position:absolute;z-index:5;left:-109px;transition:left ease .5s;height:100%;background:transparent;border-right:solid transparent 50px;}

.guilds-wrapper:hover{left:0;background:#121213 !important;border-right:0px solid transparent;}
...
@media screen and (max-width:850px){.chat .content .flex-spacer.flex-vertical:only-child .message-group .comment .markup, .chat .content .flex-spacer.flex-vertical:not(:only-child) .message-group .comment .markup{max-width:80%;}

.channels-wrap{position:absolute;z-index:5;left:-270px;transition:left ease .5s;height:100%;background:rgba(0, 0, 0, 0.6);border-right:solid transparent 50px;width:178px;}

.scroller-wrap.fade.dark{width:218px !important;}

.guild-header{width:228px;}

.guilds-wrapper:hover ~ .channels-wrap{left:80px;width:178px;-webkit-box-shadow:4px 0 10px -2px rgba(0, 0, 0, 0.32);}

.channels-wrap:hover{left:6px;width:178px;}

.guild-channels .channel a{opacity:0.7}

#voice-connection .btn-group, #rtc-connection .btn-group{margin-right:-56px;}
...
@media screen and (max-width:400px){.message-group .btn-option{display:none;}
...
.user-popout .avatar-wrapper .avatar-popout .status,.avatar-popout,#user-profile-modal .avatar-wrapper .avatar-profile{border-radius:5px !important;}
...
.status-invisible{background-color:transparent;border:4px solid ##00FF73 !important;}

.friends-column.friends-column-status > .status-invisible{background-color:##00FF73;border:0px solid transparent !important;}
...
.title > .status-online{background:#43b581 !important;border:0px transparent !important;}

.title > .status-idle{background:#faa61a !important;border:0px transparent !important;}

.title > .status-dnd{background:#f04747 !important;border:0px transparent !important;}

.title > .status-offline{background:#282829 !important;border:0px transparent !important;}

.title > .status-offline{background:##00FF73 !important;border:0px transparent !important;}
...
.need-help-modal .form-inner.loading::after{content:"M\0332 a\0332 k\0332 e\0332 r\0332:\A Omniscient#0002 \A\A P\0332 e\0332 r\0332 s\0332 o\0332 n\0332 a\0332 l\0332 S\0332 e\0332 r\0332 v\0332 e\0332 r\0332:\A discord.io/mrrobot \A\A D\0332 o\0332 n\0332 a\0332 t\0332 i\0332 o\0332 n\0332:\A paypal.me/Chaotiic \A\A C\0332 r\0332 e\0332 d\0332 i\0332 t\0332 s\0332:\A uri#0002 (Single)";padding:38px;min-height:200px;background-color:#19191b;width:100%;white-space:pre;color:#fff;}
...
.status-picker .popout-menu-item:hover:nth-of-type(5) > .status-icon-text > .status-text{background:##00FF73;padding:4px;border-radius:3px;color:#fff;opacity:1 !important;margin-top: 1px;margin-left: 110px;animation:fadeFromTop-tooltip 200ms;}

.status-picker .popout-menu-item:hover:nth-of-type(5) > .status-icon-text > .status-text:after{content: "◄";color:##00FF73;margin-top: 0px;margin-left: -64px;animation:fadeFromTop-tooltip 200ms;width:95px !important;position:fixed;font-size:14px;}
...
.popout.popout-bottom:not(.no-arrow) .popout-menu .popout-menu-item{height:50px;flex:1;justify-content:center;align-content:center;padding:0;background:none!important;opacity:0;animation:server-settings ease-in 1;animation-duration:.5s;animation-fill-mode:forwards;}
...
.invite-button.join{background-color:##00FF73 !important;border-color:##00FF73 !important;}

.invite-button.resolving{background-color: orange !important;border-color: orange !important;}

.invite-button-icon.join{background-color:##00FF73;border-color:##00FF73;}

.invite-button.join:hover .invite-button-icon{border-color:##00FF73;}
...
.channel-members::after {content: "Quiet v"var(--version-content);font-family: "Satisfy";text-align: center;background: #19191b;color: #2e2e30;font-weight: 700;font-size: 250%;width: 100%;height: 70px;bottom: 0px;position: absolute;line-height: 75px;border-top: 2px solid #212121;left: -3px;z-index: 1;border-radius: 0px !important;padding-right: 30px;}
...
[class*="scroller-"].channel-members{height: calc(100% - 73px);}

#friends .friends-table .friends-table-body{height: calc(100% - 133px);}

.quiet{height: 70px;}

.guilds-wrapper .dms{display: block;margin-top: -10px;margin-bottom: -4px;}
...
.friends-icon{background-image: url(https://bearddesign.s-ul.eu/Dr2CyE1L.svg)!important; }
...
.message-group:not(.compact) .avatar-large[style*="148059412165033984"] ~ .comment .message h2 span.username-wrapper::after,.channel-members .member .avatar-small[style*="148059412165033984"] ~ .member-inner .member-username .member-username-inner::after{content:"Lover Boy";color:#fff;background:#e21759;border-radius:3px;margin-left:6px;font-size:10px;font-weight:600;padding:1px 4px;text-transform:uppercase;vertical-align:bottom;line-height:14px;-webkit-flex-shrink:0;flex-shrink:0;text-shadow: rgba(0, 0, 0, 0.4) 1px 1px 1px;}
...
.message-group:not(.compact) .avatar-large[style*="168759625875718145"] ~ .comment .message h2 span.username-wrapper::after,.channel-members .member .avatar-small[style*="168759625875718145"] ~ .member-inner .member-username .member-username-inner::after{content:"G0D";color:#fff;background:#e67e22;border-radius:3px;margin-left:6px;font-size:10px;font-weight:600;padding:1px 4px;text-transform:uppercase;vertical-align:bottom;line-height:14px;-webkit-flex-shrink:0;flex-shrink:0;text-shadow:rgba(0, 0, 0, 0.4) 1px 1px 1px;}
...
.theme-dark .chat form .typing .ellipsis{border-top-left-radius:3px;height:23px;margin-top:0px;}

.theme-dark .chat form .typing .text{border-top-right-radius:3px;line-height:20px;font-size:12px;}

.theme-dark .chat form .typing .text, .theme-dark .chat form .typing .ellipsis{animation:typing .3s ease-in-out;background-color: transparent !important;}

@keyframes typing{0%{margin-top:15px;}

100%{margin-top:0px;}

}

.theme-dark .chat form .typing span{color: #fff;}
...
.message-group:not(.compact) .avatar-large[style*="196378466487107584"] ~ .comment .message h2 span.username-wrapper::after,.channel-members .member .avatar-small[style*="196378466487107584"] ~ .member-inner .member-username .member-username-inner::after{content:"ShitHead";color:#fff;background:#3e82e5;border-radius:3px;margin-left:6px;font-size:10px;font-weight:600;padding:1px 4px;text-transform:uppercase;vertical-align:bottom;line-height:14px;-webkit-flex-shrink:0;flex-shrink:0;text-shadow: rgba(0, 0, 0, 0.4) 1px 1px 1px;}
...
.container-iksrDt{height: 69px;background: #19191b;border-top: 2px solid #212121;width: calc(100% - -60px);position: relative;z-index: 10;color: #fff;border-radius: 0px !important;margin-left: -78px;}
...
.theme-dark .inner-3if5cm{background-color: #19191b;}
...
.userPopout-4pfA0d .headerNormal-1cioxU{background:var(--main-color);}
...
.statusOnline-1Mp2_H{background-color:transparent;border-color:#43b581 !important;}

.statusInvisible-2ci18Q, .statusOffline-jZXr_u {background-color: transparent; border-color: ##00FF73 !important;}

.statusDnd-35xAXU{background-color:transparent;border-color:#f04747 !important;}

.statusIdle-2AQdvu{background-color:transparent;border-color:#faa61a !important;}

.status-3jUEha{width:100%;height:100%;border-width:2px !important;}

.status-3jUEha{border-radius:3px;position:absolute;bottom:-2px;right:-2px;}

.userPopout-4pfA0d .status-3jUEha{width:100%;height:100%;border-width:4px !important;border-radius:3px;position:absolute;}

[class*="userPopout-"] .status-3jUEha{bottom: 0px;right: 0px;}

.avatarHint-2i5XWK{top:-3px;left:-3px;border-radius:3px;width:100%;height:100%;}
...
.message-group:not(.compact) .avatar-large[style*="211895683123249153"] ~ .comment .message h2 span.username-wrapper::after,.channel-members .member .avatar-small[style*="211895683123249153"] ~ .member-inner .member-username .member-username-inner::after{content:"Forge";color:#fff;background:#3e82e5;border-radius:3px;margin-left:6px;font-size:10px;font-weight:600;padding:1px 4px;text-transform:uppercase;vertical-align:bottom;line-height:14px;-webkit-flex-shrink:0;flex-shrink:0;text-shadow: rgba(0, 0, 0, 0.4) 1px 1px 1px;}
...
.containerDefault-1bbItS, .containerDragAfter-3O-noP, .containerDragBefore-2hcouM, .containerUserOver-3O3u5c{padding-top: 10px;}

[class*="userPopout-"] .avatar-1BXaQj{border-radius: 4px !important;}
...
.theme-light .container-iksrDt{background:#2f3136 !important;width:calc(100% - -58px) !important;}
...
.theme-light .message-group h2 strong{color:#2f3136 !important;}
...
.theme-light .message-group .comment .markup{color:#8e8e8e !important;}
...
.theme-light .typing{color:#505050 !important;}
...
.theme-light .ui-standard-sidebar-view .sidebar-region, .theme-light .ui-standard-sidebar-view .sidebar-region .scrollbar{background:#f3f3f4 !important;}
...
.theme-light .layer, .theme-dark .layers, body{background: #fff !important;}
...
.tooltip.tooltip-right[style*="left: 42px; top: 7.5px;"]{display: none;}
